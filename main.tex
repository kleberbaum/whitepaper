...
\newcommand{\authorname}{Florian Herbert Kleber} % The author name without titles.
\newcommand{\thesistitle}{Bias und Alignment in Sprachmodellen: \ Grundbegriffe und Fallstudien zu KI} % The title of the thesis. The English version should be used, if it exists.
...
\Publisher{Netsnek}                                     % The document's publisher in the document properties.
\Subject{White Paper}                                        % The document's subject in the document properties.
\end{filecontents*}
...
\setdate{06}{05}{2025} % Set date with 3 arguments: {day}{month}{year}.
...
\setwhitepaper
\setauthor{}{Florian Herbert Kleber}{}{}
\setdate{06}{05}{2025}
\settitle{\thesistitle}{Bias und Alignment in Sprachmodellen}
...
% Dokumentations-Tabelle zur Versionen historien
\chapter*{Historie der Dokumentversionen}
\begin{table}[h] % or just \begin{table}
    \centering
    \begin{tabular}{|c|c|c|p{8cm}|}
    \hline
    \textbf{Version} & \textbf{Datum} & \textbf{Autor} & \textbf{Änderungsgrund / Bemerkungen} \\
    \hline
    1.0 & 06.05.2025 & Florian Herbert Kleber & Initiale Version \\
    % Weitere Einträge
    \hline
    \end{tabular}
\end{table}
...
% \begin{aitools}
% \todo{Zur Verbesserung der Rechtschreibung und des Satzbaues wurde an Open AI GPT 4.1 herangezogen.}
% \end{aitools}

% \begin{kitools}
% Zur Verbesserung der Rechtschreibung und des Satzbaues und Übersetzung wurde an Open AI GPT 4.1 herangezogen. Der Rest wurde durch die anwendung von Natürlicher Inteligenz geschaffen.
% \end{kitools}
